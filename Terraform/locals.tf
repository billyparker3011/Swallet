...
locals {
  ...
  agw_gateway_ip_configuration_name              = "gwip-${local.name_suffix}"
  agw_frontend_port_name                         = "feport-${local.name_suffix}"
  agw_frontend_ip_configuration_name             = "feip-${local.name_suffix}"
  agw_backend_address_pool_name                  = "beap-${local.name_suffix}"
