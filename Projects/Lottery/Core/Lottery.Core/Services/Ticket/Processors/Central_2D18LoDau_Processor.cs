...
public class Central_2D18LoDau_Processor : AbstractBetKindProcessor
{
    private const int _startedPrize = 1;

    public Central_2D18LoDau_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }
    ...
    public override int BetKindId { get; set; } = Enums.BetKind.Central_2D18LoDau.ToInt();
