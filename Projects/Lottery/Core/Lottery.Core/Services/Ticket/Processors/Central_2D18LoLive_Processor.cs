...
public class Central_2D18LoLive_Processor : AbstractBetKindProcessor
{
    public Central_2D18LoLive_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Central_2D18LoLive.ToInt();
