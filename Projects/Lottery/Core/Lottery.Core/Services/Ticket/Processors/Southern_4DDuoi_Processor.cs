...
public class Southern_4DDuoi_Processor : AbstractBetKindProcessor
{
    private const int _resultPrize = 9;

    public Southern_4DDuoi_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Southern_4DDuoi.ToInt();
