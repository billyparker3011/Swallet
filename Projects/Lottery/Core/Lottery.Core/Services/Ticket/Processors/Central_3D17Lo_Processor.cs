...
public class Central_3D17Lo_Processor : AbstractBetKindProcessor
{
    private const int _resultFromPrize = 2;
    private const int _resultToPrize = 9;   //  Include special

    public Central_3D17Lo_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Central_3D17Lo.ToInt();
