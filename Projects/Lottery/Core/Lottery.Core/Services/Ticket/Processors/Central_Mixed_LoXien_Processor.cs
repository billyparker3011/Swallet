...
public class Central_Mixed_LoXien_Processor : AbstractBetKindProcessor
{
    private readonly Dictionary<int, int> _subBetKindIds = new()
    {
        { Enums.BetKind.Central_Mixed_Xien2.ToInt(), 2 },
        { Enums.BetKind.Central_Mixed_Xien3.ToInt(), 3 },
        { Enums.BetKind.Central_Mixed_Xien4.ToInt(), 4 }
    };

    public Central_Mixed_LoXien_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }
