...
public class SecondNorthern_Northern_2DDuoi_Processor : AbstractBetKindProcessor
{
    private const int _resultPrize = 9;

    public SecondNorthern_Northern_2DDuoi_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.SecondNorthern_Northern_2DDuoi.ToInt();
