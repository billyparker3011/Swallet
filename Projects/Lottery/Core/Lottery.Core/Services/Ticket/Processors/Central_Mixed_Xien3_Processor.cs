...
public class Central_Mixed_Xien3_Processor : AbstractBetKindProcessor
{
    private const int _numberOfChannels = 2;

    public Central_Mixed_Xien3_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Central_Mixed_Xien3.ToInt();
