...
public class Central_3DDuoi_Processor : AbstractBetKindProcessor
{
    private const int _resultPrize = 9;

    public Central_3DDuoi_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Central_3DDuoi.ToInt();
