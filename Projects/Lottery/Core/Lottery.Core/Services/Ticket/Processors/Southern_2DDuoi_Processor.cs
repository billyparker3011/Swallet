...
public class Southern_2DDuoi_Processor : AbstractBetKindProcessor
{
    private const int _startedPrize = 9;

    public Southern_2DDuoi_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Southern_2DDuoi.ToInt();
