...
public class Southern_2D18LoDau_Processor : AbstractBetKindProcessor
{
    private const int _startedPrize = 1;

    public Southern_2D18LoDau_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }
    ...
    public override int BetKindId { get; set; } = Enums.BetKind.Southern_2D18LoDau.ToInt();
