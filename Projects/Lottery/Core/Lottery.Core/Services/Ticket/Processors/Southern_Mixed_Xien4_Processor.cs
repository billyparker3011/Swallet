...
public class Southern_Mixed_Xien4_Processor : AbstractBetKindProcessor
{
    public Southern_Mixed_Xien4_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Southern_Mixed_Xien4.ToInt();
