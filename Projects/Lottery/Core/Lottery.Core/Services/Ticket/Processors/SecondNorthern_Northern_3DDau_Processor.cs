...
public class SecondNorthern_Northern_3DDau_Processor : AbstractBetKindProcessor
{
    private const int _resultPrize = 7;

    public SecondNorthern_Northern_3DDau_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.SecondNorthern_Northern_3DDau.ToInt();
