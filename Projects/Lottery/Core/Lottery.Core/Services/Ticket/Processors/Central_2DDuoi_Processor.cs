...
public class Central_2DDuoi_Processor : AbstractBetKindProcessor
{
    private const int _startedPrize = 9;

    public Central_2DDuoi_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Central_2DDuoi.ToInt();
