...
public class SecondNorthern_Northern_2D27Lo_Processor : AbstractBetKindProcessor
{
    private const int _startedPrize = 2;    //  Exclude Than Tai

    public SecondNorthern_Northern_2D27Lo_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.SecondNorthern_Northern_2D27Lo.ToInt();
