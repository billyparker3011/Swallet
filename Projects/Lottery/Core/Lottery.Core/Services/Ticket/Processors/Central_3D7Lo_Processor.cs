...
public class Central_3D7Lo_Processor : AbstractBetKindProcessor
{
    private const int _resultPrize = 9;
    private const int _resultFirstFourth = 5;
    private const int _resultFromPrize = 2;
    private const int _resultToPrize = 4;

    public Central_3D7Lo_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Central_3D7Lo.ToInt();
