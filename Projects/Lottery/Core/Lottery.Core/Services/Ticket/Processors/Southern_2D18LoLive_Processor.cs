...
public class Southern_2D18LoLive_Processor : AbstractBetKindProcessor
{
    public Southern_2D18LoLive_Processor(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }

    public override int BetKindId { get; set; } = Enums.BetKind.Southern_2D18LoLive.ToInt();
    ...
    public override CompletedTicketResultModel Completed(CompletedTicketModel ticket, List<PrizeMatchResultModel> result)
    {
        ...
        var startOfPosition = Region.Central.ToInt().GetStartOfPosition();
