...
namespace Lottery.Core.Services.Odds
{
    public interface IProcessOddsService : IScopedDependency
    {
        ...
        Task<Dictionary<int, decimal>> GetMixedRateOfOddsValue(long matchId, List<int> betKindIds);
        ...
        Task UpdateMixedRateOfOddsValue(long matchId, Dictionary<int, decimal> rateByBetKind);
    }
}
