...
namespace Lottery.Core.Services.Player
{
    public class PlayerService : LotteryBaseService<PlayerService>, IPlayerService
    {
        ...
        public async Task CreatePlayer(CreatePlayerModel model)
        {
            ...
            var cockFightPlayerBetSettingRepos = LotteryUow.GetRepository<ICockFightPlayerBetSettingRepository>();
            ...
            await cockFightPlayerBetSettingRepos.AddRangeAsync(defaultCockFightPlayerBetSettings);
        ...
        public async Task UpdatePlayerCreditBalance(UpdatePlayerCreditBalanceModel updateItem)
        {
            ...
            var availableCreditOfAgent = await playerRepos.FindQueryBy(x => x.AgentId == agent.AgentId && x.PlayerId != updatedPlayer.PlayerId).SumAsync(x => x.Credit);
