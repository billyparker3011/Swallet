...
namespace Lottery.Core.Enums
{
    public enum SubCategory
    {
        ...
        [EnumSubCategoryDescription("2D", 1, Category.SecondNorthern, BetKind.None, new[] { BetKind.SecondNorthern_Northern_2DDau, BetKind.SecondNorthern_Northern_2DDuoi, BetKind.SecondNorthern_Northern_2D27Lo })]
        D2 = 3,
